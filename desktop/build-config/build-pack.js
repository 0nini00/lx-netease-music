...
*/
const options = {
  appId: 'cn.chenle.lx.netease.music.desktop',
  productName: 'lx-netease-music-desktop',
  beforePack,
  afterPack,
  protocols: {
  ...
  files: [
...

    {
      ...
      from: 'node_modules/font-list',

      to: 'node_modules/font-list',
...

    {
      ...
      from: 'node_modules/electron-font-manager',

      to: 'node_modules/electron-font-manager',
      ...
      filter: [
        ...
        'build/Release/font_manager.node',
...

    {
      ...
      from: 'node_modules/utf-8-validate',

      to: 'node_modules/utf-8-validate',
...
const winOptions = {
  ...
  nsis: {
    ...
    shortcutName: 'lx-netease-music-desktop',
  },
}
/**
 * @type {import('electron-builder').Configuration}
...
const linuxOptions = {
  linux: {
    ...
    desktop: {
      ...
      entry: {
        Name: 'lx-netease-music-desktop',
        'Name[zh_CN]': 'lx-netease-music-desktop',
        'Name[zh_TW]': 'lx-netease-music-desktop',
        Encoding: 'UTF-8',
...
const macOptions = {
  ...
  dmg: {
    ...
    title: 'lx-netease-music-desktop v${version}',
  },
}
