...
export default () => {
  ...
  mainHandle<LX.UserApi.UserApiSyncData>(WIN_MAIN_RENDERER_EVENT_NAME.export_user_api_full, async() => {
    return exportApiFull()
  })

  mainHandle<LX.UserApi.UserApiSyncData, LX.UserApi.UserApiInfo[]>(WIN_MAIN_RENDERER_EVENT_NAME.overwrite_user_api_full, async({ params: apis }) => {
    return overwriteApiFull(apis)
  })
