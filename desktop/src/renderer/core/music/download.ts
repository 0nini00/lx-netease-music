...
export const getMusicUrl = async({ musicInfo, isRefresh, allowToggleSource = true, skipPrimarySource = false, onToggleSource = () => {} }: {
  ...
  return getOnlineMusicUrl({ musicInfo: musicInfo.metadata.musicInfo, isRefresh, onToggleSource, allowToggleSource, skipPrimarySource })
}
