...
export const exportUserApiFull = async() => {
  return rendererInvoke<LX.UserApi.UserApiSyncData>(WIN_MAIN_RENDERER_EVENT_NAME.export_user_api_full)
}
export const overwriteUserApiFull = async(apis: LX.UserApi.UserApiSyncData) => {
  return rendererInvoke<LX.UserApi.UserApiSyncData, LX.UserApi.UserApiInfo[]>(WIN_MAIN_RENDERER_EVENT_NAME.overwrite_user_api_full, apis)
}
