...
dd
  h3#play_music_url_source {{ $t('setting__play_music_url_source') }}
  div
    base-checkbox.gap-left(id="setting_music_play_source_source" name="setting_music_play_source" need :model-value="appSetting['common.music_api_gateway_enable']" :value="false" :label="$t('setting__play_music_url_source_source')" @update:model-value="updateSetting({ 'common.music_api_gateway_enable': $event })")
    base-checkbox.gap-left(id="setting_music_play_source_gateway" name="setting_music_play_source" need :model-value="appSetting['common.music_api_gateway_enable']" :value="true" :label="$t('setting__play_music_url_source_gateway')" @update:model-value="updateSetting({ 'common.music_api_gateway_enable': $event })")
