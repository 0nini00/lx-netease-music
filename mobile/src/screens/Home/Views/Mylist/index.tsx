...
import { scanAndImportLocalMusic } from '@/core/localMusic'
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.downloadBtn} activeOpacity={0.75} onPress={scanAndImportLocalMusic}>
          <Icon name="add-music" size={16} color={theme['c-font-label']} />
          <Text style={styles.downloadText} size={12} color={theme['c-font-label']}>扫描</Text>
        </TouchableOpacity>
