    ...
    <Animated.View style={[styles.container, { transform: [{ scale: scaleAnim }] }]}>
      <TouchableOpacity onPress={handlePress}>
        <Progress.Circle
          ...
          showsText={false}
          color={isCompleted ? (theme as any)['c-success'] : theme['c-primary']}
          unfilledColor="rgba(0,0,0,0.2)"
          borderWidth={0}
          thickness={3}
        />
        <View style={styles.iconContainer}>
          <Icon name={isCompleted ? "checkbox-marked" : "download-2"} size={22} color={isCompleted ? (theme as any)['c-success'] : theme['c-primary-font-active']} />
        </View>
      </TouchableOpacity>
    </Animated.View>
  );
