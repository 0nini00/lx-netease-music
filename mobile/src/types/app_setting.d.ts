...
declare global {
  namespace LX {
    ...
    interface AppSetting {
      ...
      /**
       * 播放方式：false 为音源轮询，true 为音乐 API 网关
       */
      'common.music_play_use_gateway': boolean
      /**
       * 兼容旧配置，播放方式请使用 common.music_play_use_gateway
       */
      'common.music_api_gateway_enable': boolean
      'common.music_api_gateway_url': string
      'common.music_api_gateway_header_name': string
      'common.music_api_gateway_header_value': string
